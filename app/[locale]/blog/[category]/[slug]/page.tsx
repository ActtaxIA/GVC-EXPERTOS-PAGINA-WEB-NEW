            ...
            <article className="lg:col-span-2">
              <div 
                className="prose prose-lg max-w-none
                  ...
                  prose-ol:text-gray-700 prose-ol:my-4 prose-ol:list-decimal prose-ol:pl-6
                  prose-li:mb-2 prose-li:leading-relaxed
                  prose-blockquote:border-l-4 prose-blockquote:border-gold prose-blockquote:pl-4 prose-blockquote:italic prose-blockquote:text-gray-600
