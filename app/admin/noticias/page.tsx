      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Crea y administra las noticias del sector
          </p>
        </div>
        <Link
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                filter === 'all' ? 'bg-charcoal text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              }`}
            >
              Todas
            </button>
      ...
      <div className="bg-white rounded-lg shadow-sm">
        {isLoading ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p>No hay noticias</p>
            <Link href="/admin/noticias/nueva" className="text-gold hover:underline text-sm">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b bg-gray-50">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-600">Fuente</th>
                  ...
                  <tr key={item.id} className="hover:bg-gray-50">
                    <td className="py-4 px-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 truncate max-w-md">{item.excerpt}</p>
                      </div>
                    </td>
                    <td className="py-4 px-4">
